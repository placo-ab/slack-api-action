...
exports = module.exports = __webpack_require__(939);
exports.log = log;
...
var abort = __webpack_require__(218)
  , async = __webpack_require__(893)
  ;
...
const packageJson = __webpack_require__(60); // tslint:disable-line:no-require-imports no-var-requires
/**
...
try {
  var supportsColor = __webpack_require__(308);
...
var createError = __webpack_require__(566);
...
var isAbsoluteURL = __webpack_require__(766);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(943);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __webpack_require__(614);
  }
  return adapter;
}
...
var debug = __webpack_require__(555)("follow-redirects");
...
const is_stream_1 = __importDefault(__webpack_require__(883));
const p_queue_1 = __importDefault(__webpack_require__(147)); // tslint:disable-line:import-name
const p_retry_1 = __importStar(__webpack_require__(488));
const axios_1 = __importDefault(__webpack_require__(366));
const form_data_1 = __importDefault(__webpack_require__(305)); // tslint:disable-line:import-name
const methods_1 = __webpack_require__(663);
const instrument_1 = __webpack_require__(50);
const errors_1 = __webpack_require__(18);
const logger_1 = __webpack_require__(921);
const retry_policies_1 = __importDefault(__webpack_require__(421));
const helpers_1 = __webpack_require__(454);
/**
...
module.exports =
{
  parallel      : __webpack_require__(634),
  serial        : __webpack_require__(760),
  serialOrdered : __webpack_require__(674)
};
...
var CombinedStream = __webpack_require__(924);
var util = __webpack_require__(669);
...
var mime = __webpack_require__(423);
var asynckit = __webpack_require__(235);
var populate = __webpack_require__(315);
...
const { WebClient } = __webpack_require__(586);
...
var db = __webpack_require__(520)
...
var isCancel = __webpack_require__(752);
...
const retry = __webpack_require__(26);
...
var mergeConfig = __webpack_require__(781);
...
var async = __webpack_require__(893)
  , abort = __webpack_require__(218)
  ;
...
var enhanceError = __webpack_require__(948);
...
Object.defineProperty(exports, "__esModule", { value: true });
var WebClient_1 = __webpack_require__(156);
...
var http = __webpack_require__(605);
var https = __webpack_require__(211);
var httpFollow = __webpack_require__(150).http;
var httpsFollow = __webpack_require__(150).https;
var url = __webpack_require__(835);
var zlib = __webpack_require__(761);
var pkg = __webpack_require__(481);
var createError = __webpack_require__(566);
var enhanceError = __webpack_require__(948);
...
var iterate    = __webpack_require__(542)
  , initState  = __webpack_require__(759)
  , terminator = __webpack_require__(43)
  ;
...
const WebClient_1 = __webpack_require__(156);
const eventemitter3_1 = __webpack_require__(53);
...
var RetryOperation = __webpack_require__(265);
...
var serialOrdered = __webpack_require__(674);
...
axios.CancelToken = __webpack_require__(464);
axios.isCancel = __webpack_require__(752);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(708);
...
var defer = __webpack_require__(584);
...
const logger_1 = __webpack_require__(905);
var logger_2 = __webpack_require__(905);
...
var buildURL = __webpack_require__(553);
var buildFullPath = __webpack_require__(79);
var parseHeaders = __webpack_require__(895);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(600);
